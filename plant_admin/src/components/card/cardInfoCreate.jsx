...
const CardInfo = () => {
            ...
            ? // tab2?.name_ru&&
              ...
              axiosInstance
                  ...
                  .then((res) => {
                      ...
                      navigate("/plantCreate/" + res.data.id);
                  })
                  .catch((err) => {
                      console.log(err);
                  })
    ...
    const getPlants = () => {
        axiosInstance.get("/api/get-admin-plant").then((res) => {
            console.log("data maps", res.data);
            setPlant(res.data);
        });
    };
        ...
        <div className="esasyDiv" style={{ width: "100%" }}>
            ...
            <button className="createBtn" style={{top:"10px"}}>Create+</button>
                ...
                >
                    <h1
                        onClick={() => setIndex(1)}
                        className={index == 1 && "activeTabHeader"}
                    >
                        Таксономия
                    </h1>
                    <h1
                        onClick={() => setIndex(2)}
                        className={index == 2 && "activeTabHeader"}
                    >
                        Названия
                    </h1>
