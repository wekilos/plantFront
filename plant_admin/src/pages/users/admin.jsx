...
const AddUser = ()=>{
    ...
    const getUsers = ()=>{
        axiosInstance.get("/api/get-admins").then((res)=>{
    ...
    const createUser =()=>{
        axiosInstance.post("/api/create-admin",{
            username:addUser,
    ...
    const changeActive = (data)=>{
        axiosInstance.put("/api/update-admin-is-active/"+data.id,{
    ...
    const editUser = ()=>{
        axiosInstance.put("/api/update-admin/"+userData.id,{
    ...
    const delateUser = (id)=>{
        console.log(id)
        axiosInstance.put("/api/delete-admin/"+id,{
            is_deleted:true
        }).then((data)=>{
            console.log(data.data);
            message.success(data.data.status);
